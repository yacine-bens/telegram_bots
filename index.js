...
app.listen(process.env.PORT || 5000, async () => {
    ...
    let response = await axios.get(`https://${VERCEL_URL}/forhire/setWebhook`);
    console.log(response.data);
    response = await axios.get(`https://${VERCEL_URL}/phones/setWebhook`);
    console.log(response.data);
    response = await axios.get(`https://${VERCEL_URL}/words/setWebhook`);
    console.log(response.data);
});
